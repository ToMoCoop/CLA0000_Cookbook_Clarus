...
%w{appbox apt build-essential  database imagemagick java logrotate newrelic nginx nodejs postgresql rbenv redisio  ruby_build runit sqlite unicorn}.each do |cb|
  depends cb
end